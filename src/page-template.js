...
// this does two tasks: takes the array of the project data and creates a new array from it called projectsHtmlArr.
//then we take that array and interpolate it into the returning project <section> element template literal
// we use the .join method to turn the projectHtmlArr into a combined string of HTML before returning as well.
